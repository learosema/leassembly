(module
 ...
 (import "index" "initCanvas" (func $assembly/index/initCanvas (param f64 f64)))
 (import "Math" "random" (func $~lib/bindings/Math/random (result f64)))
 (import "Math" "floor" (func $~lib/bindings/Math/floor (param f64) (result f64)))
 (import "index" "noStroke" (func $assembly/index/noStroke))
 (import "index" "fill" (func $assembly/index/fill (param i32)))
 (import "index" "stroke" (func $assembly/index/stroke (param i32)))
 (import "index" "circle" (func $assembly/index/circle (param f64 f64 f64)))
 (table $0 1 funcref)
 ...
 (func $assembly/index/setup (; 34 ;) (type $FUNCSIG$v)
  f64.const 600
  f64.const 600
  call $assembly/index/initCanvas
 )
 (func $assembly/index/draw (; 35 ;) (type $FUNCSIG$vd) (param $0 f64)
  (local $1 i32)
  (local $2 f64)
  (local $3 f64)
